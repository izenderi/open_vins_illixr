...
// <RTEN>
    ...
    std::this_thread::sleep_for(std::chrono::milliseconds(2000)); // manual sleep to control load
...
#ifndef NDEBUG
    // Timing information
    printf(BLUE "<RTEN> OpenVINS : start %02ld:%02ld:%02ld.%03ld \n" RESET, hours, minutes, seconds, milliseconds);
